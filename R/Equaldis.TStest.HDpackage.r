...
#' the two populations. In other words, the null hypothesis is an intersection of the p null hypothesis
...
#' is rejected such permutation p-values can also be used to identify which variables have been contributed
#' to this significance. The standarized version of each test statistic and its p-value are computed among
#' other things.
#'
#'
#' @details
